<?php require APPROOT . '/views/inc/header.php'; ?>
  ...
  <div class="card card-body bg-light mt-4 shadow-sm">
    ...
    <form action="<?php echo URLROOT; ?>/loans/edit/<?php echo $data['id']; ?>" method="post">
      <div class="row">
          <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="debtor_name" class="form-control form-control-lg <?php echo (!empty($data['debtor_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['debtor_name']; ?>">
      ...
      <input type="submit" class="btn btn-success btn-block" value="Actualizar Préstamo">
    </form>
  </div>
